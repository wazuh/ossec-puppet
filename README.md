...
This module was forked from `mrbanzai/puppet-ossec`, which was forked from `djjudas21/puppet-ossec` to be packaged for Puppet
Forge. This fork is maintained to support the OSSEC deployment, and is for general
consumption. Feel free to contribute any changes there.
